...
\lstlistingwithnumber{92}{97}{BasicVideoFilteringOpenCV.cxx}
...
\lstlistingwithnumber{103}{106}{BasicVideoFilteringOpenCV.cxx}
\end{itemize}
\end{center}
\end{frame}
...
\lstlistingwithnumber{68}{71}{BasicVideoFilteringOpenCV.cxx}
\end{itemize}
\end{center}
\end{frame}
...
\begin{itemize}
\item Loop until no more frames can be read from the video capture object.
\lstlistingwithnumber{72}{78}{BasicVideoFilteringOpenCV.cxx}
\item Call {\tt\small processFrame()} on each frame and and display the result.
...
\lstlistingwithnumber{80}{80}{BasicVideoFilteringOpenCV.cxx}
\end{itemize}
\end{center}
\end{frame}
